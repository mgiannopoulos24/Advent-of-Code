...
hallway_length = 11
room_depth = 2  # Two rows deep

# Parse the input to get the initial state
def parse_input(input_lines):
    hallway = ['.'] * hallway_length
    rooms = [
        [input_lines[2][3], input_lines[3][3]],  # Room for A
        [input_lines[2][5], input_lines[3][5]],  # Room for B
        [input_lines[2][7], input_lines[3][7]],  # Room for C
        [input_lines[2][9], input_lines[3][9]]   # Room for D
    ]
