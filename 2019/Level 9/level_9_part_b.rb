class IntcodeComputer
  ...
  # Initialize the Intcode computer with the program and run it in sensor boost mode (input 2)
  computer = IntcodeComputer.new(input_file)
  output = computer.run(2)
  
  # Output the coordinates of the distress signal
  puts "Coordinates of the distress signal: #{output.last}"
