...
# Method to run the painting robot, starting on a white panel
def run_painting_robot_with_visualization(program)
  computer = IntcodeComputer.new(program)
  grid = Hash.new(0)  # 0 = black panel, 1 = white panel
  grid[[0, 0]] = 1    # Starting on a white panel for Part Two
...
# Method to display the painted grid
...
if __FILE__ == $PROGRAM_NAME
  ...
  run_painting_robot_with_visualization(program)
end
