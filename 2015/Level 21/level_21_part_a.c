...
bool player_wins(int player_damage, int player_armor) {
...
int main() {
        ...
        for (int a = 0; a < NUM_ARMORS; a++) {
            for (int r1 = 0; r1 < NUM_RINGS; r1++) {
                for (int r2 = 0; r2 < NUM_RINGS; r2++) {
                    ...
                    if (player_wins(total_damage, total_armor) && total_cost < min_gold_spent) {
    ...
    printf("The least amount of gold you can spend and still win the fight is: %d\n", min_gold_spent);
